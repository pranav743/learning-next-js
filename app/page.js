            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Optimized with Next.js for superior performance and user experience.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Enterprise-grade security with NextAuth.js and OAuth integration.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Real-time insights and detailed reporting for better decision making.
                </p>
              </div>
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-2">
            ...
            <Link href="/auth/signin" className="text-gray-400 hover:text-gray-500">
              Sign In
            </Link>
          </div>
